...
class env_config_t :
 ...
 public:
  ...
  enum : int {
    ...
    kEnvCaPrivKeyFileFieldNumber = 23,
    ...
    kEnvPidFieldNumber = 20,
    kEnvIpv4EnabledFieldNumber = 14,
    kEnvBroadcastIntervalMsFieldNumber = 19,
  };
  // required bytes env_name = 1 [default = ""];
  bool has_env_name() const;
  private:
  ...
  bool has_domain_udp_socket_path() const;
  private:
  bool _internal_has_domain_udp_socket_path() const;
  public:
  void clear_domain_udp_socket_path();
  const std::string& domain_udp_socket_path() const;
  void set_domain_udp_socket_path(const std::string& value);
  void set_domain_udp_socket_path(std::string&& value);
  void set_domain_udp_socket_path(const char* value);
  void set_domain_udp_socket_path(const void* value, size_t size);
  std::string* mutable_domain_udp_socket_path();
  std::string* release_domain_udp_socket_path();
  void set_allocated_domain_udp_socket_path(std::string* domain_udp_socket_path);
  private:
  const std::string& _internal_domain_udp_socket_path() const;
  void _internal_set_domain_udp_socket_path(const std::string& value);
  std::string* _internal_mutable_domain_udp_socket_path();
  public:
